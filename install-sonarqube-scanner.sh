...
rm    -rf $HOME/sonar-scanner-cli.zip                                                                                                           && \
mv        $HOME/sonar-scanner-* sonarscanner                                                                                                    && \
rm    -rf $HOME/sonarscanner/jre/{legal,release}                                                                                                && \
echo "export PATH=$PATH:$HOME/sonarscanner/bin" >> $HOME/.bashrc                                                                                && \
exec $BASH
